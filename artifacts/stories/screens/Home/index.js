                    ...
                    React.createElement(View, { style: styles.itemFooter },
                        ...
                        React.createElement(View, { style: { flex: 1, flexDirection: "row", justifyContent: "flex-end", alignContent: "flex-end", alignItems: "flex-end" } },
                            React.createElement(View, { style: styles.itemFooterIcon },
                                React.createElement(Icon, { style: { fontSize: 20, color: "grey" }, active: true, name: "log-in", onPress: () => this.props.navigation.navigate("Login") })),
                            React.createElement(Text, { style: { color: '#ddd' } }, "21"))),
                    React.createElement(View, { style: styles.itemComments },
                        React.createElement(Left, { style: { flex: 1 } },
                            React.createElement(Image, { style: { width: 40, height: 40, borderRadius: 20 }, source: { uri: 'https://scontent.fhan2-1.fna.fbcdn.net/v/t1.0-1/p40x40/32260818_1842940525751056_6312713214782078976_n.jpg?_nc_cat=103&_nc_ht=scontent.fhan2-1.fna&oh=66386ff61099c3d018d98ef65ab63c35&oe=5C6FF586' } })),
                        React.createElement(Body, { style: { flex: 4, alignContent: 'flex-start', alignItems: 'flex-start' } },
                            React.createElement(Text, { style: { fontWeight: "bold" } }, "Tu\u1EA5n Anh"),
                            React.createElement(Text, null, "C\u0169ng h\u01A1i h\u01A1i hay m\u00E0 th\u00F4i. Kh\u00F4ng qu\u00E1 x\u00E0m"))))))))));
    }
}
export default Home;
