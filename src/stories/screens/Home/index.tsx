            ...
            {this.props.list.map((item, i) => (
              ...
              >
                ...
                <View style={styles.itemComments}>
                  ...
                  <Body style={{flex:4, alignContent: 'flex-start', alignItems: 'flex-start'}}>
                    <Text style={{fontWeight:"bold"}}>Tuấn Anh</Text>
                    <Text>Cũng hơi hơi hay mà thôi. Không quá xàm</Text>
                  </Body>
                  </View>
              </ListItem>
            ))}
